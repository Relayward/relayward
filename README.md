...
Relayward 目前仍在积极开发中，当前版本面向自托管 Linux AMD64 环境。
...
安装插件时，打开**插件**并选择**安装插件**，填写插件的 GitHub 仓库、明确的发布版本以及私有仓库所需的可选令牌。选择**检查版本**，核对清单和制品信息，批准插件申请的每一项权限，然后安装。
